...
|====
|Tâche |Quand |Fait |Remarques
|Avoir accès à la BD OpenFoodFacts | |pour récupérer les valeurs nutritifs des produits |
|Structurer une BD consommation | |utile pour stocker la consommation par utilisateur et pouvoir faire le suivi  |
