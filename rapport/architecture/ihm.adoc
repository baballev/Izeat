...
image::../images/storyboard/profil_bouton_haut_droit_cliqué[Onglet profil, 600, 1000]
image::../images/storyboard/profil_bouton_haut_droit_cliqué_ami[Première ouverture de l'application, 600, 1000]