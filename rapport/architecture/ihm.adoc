...
De plus une partie importante de l'application est le côté progressif de
l'application. Plus la fréquence d'utilisation est élevée, plus l'utilisateur
lui verra proposé des nouvelles fonctionnalités qui seraient inutiles pour un
...
On voit ci dessus (4 premières images) que l'on va devoir coder une première 
